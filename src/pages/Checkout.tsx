...
import { resetCart, selectCartItem, selectCartTotal } from "../store/cartSlice";
import { formatPrice } from "../utils/price-utils";
import { createOrderId } from "../utils/order-utils";
import { createOrders } from "../store/ordersSlice";
...
const Checkout = () => {
  ...
  return (
    <div className="my-6">
      ...
      <h2 className="text-3xl my-auto text-center">checkout</h2>
      {cartItems.length ? (
        ...
        <h3 className="text-2xl text-center">No items in the checkout</h3>
      )}
    </div>
  );
};
